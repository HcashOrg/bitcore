...
Address.fromPubKey = function(pubKey, network) {
  ...
  var hash = coinUtil.hash160(pubKey);
  ...
  if (payload) {
    ...
    switch (txType) {
      case Script.TX_PUBKEY:
        payload[0] = coinUtil.hash160(payload[0]);
      ...
      case Script.TX_MULTISIG:
        ...
        for (var i in payload)
          payload[i] = coinUtil.hash160(payload[i]);
        break;
...
Address.prototype.network = function() {
  ...
  var livenet = networks.hcdlivenet;
  var testnet = networks.hcdtestnet;
