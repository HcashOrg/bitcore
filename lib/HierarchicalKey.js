...
var HierarchicalKey = function(bytes) {
  if (typeof bytes == 'undefined' || bytes == 'mainnet' || bytes == 'hcdlivenet') {
    bytes = 'hcdlivenet';
    this.version = networks['hcdlivenet'].hkeyPrivateVersion;
  } else if (bytes == 'hcdtestnet') {
    this.version = networks['hcdtestnet'].hkeyPrivateVersion;
  }
  if (bytes == 'hcdlivenet' || bytes == 'hcdtestnet') {
    this.depth = 0x00;
...
HierarchicalKey.prototype.initFromBytes = function(bytes) {
  ...
  var isPublic =
    (this.version == networks['hcdlivenet'].hkeyPublicVersion ||
      this.version == networks['hcdtestnet'].hkeyPublicVersion);
...
HierarchicalKey.prototype.buildExtendedPublicKey = function() {
  ...
  var v = null;
  switch (this.version) {
    case networks['hcdlivenet'].hkeyPublicVersion:
    case networks['hcdlivenet'].hkeyPrivateVersion:
      v = networks['hcdlivenet'].hkeyPublicVersion;
      break;
    case networks['hcdtestnet'].hkeyPublicVersion:
    case networks['hcdtestnet'].hkeyPrivateVersion:
      v = networks['hcdtestnet'].hkeyPublicVersion;
      break;
    default:
