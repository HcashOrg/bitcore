...
TransactionBuilder.infoForP2sh = function(opts, networkName) {
  ...
  var version = networkName === 'hcdtestnet' ?
    networks.hcdtestnet.P2SHVersion : networks.hcdlivenet.P2SHVersion;
...
TransactionBuilder.prototype._multiFindKey = function(walletKeyMap, pubKeyHash) {
  var wk;
  [networks.hcdlivenet, networks.hcdtestnet].forEach(function(n) {
